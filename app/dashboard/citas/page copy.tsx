...
export default function CitasPage() {
  ...
  return (
    <div>
      ...
      <iframe className="google-calendar-iframe" src="https://calendar.google.com/calendar/embed?height=600&wkst=2&ctz=America%2FMexico_City&showTitle=1&showPrint=0&showCalendars=0&showTz=0&mode=WEEK&&src=Y2FsLnBpZXplbi5wb3phcmljYXBldHJvbWV4QGdtYWlsLmNvbQ&src=ZXMtNDE5Lm1leGljYW4jaG9saWRheUBncm91cC52LmNhbGVuZGFyLmdvb2dsZS5jb20&color=%23039be5&color=%230b8043"></iframe>

      </div>
{/* <iframe src="https://calendar.google.com/calendar/embed?height=600&wkst=1&ctz=America%2FMexico_City&showPrint=0&src=Y2FsLnBpZXplbi5wb3phcmljYXBldHJvbWV4QGdtYWlsLmNvbQ&src=ZXMtNDE5Lm1leGljYW4jaG9saWRheUBncm91cC52LmNhbGVuZGFyLmdvb2dsZS5jb20&color=%23039be5&color=%230b8043" style="border:solid 1px #777" width="800" height="600" frameborder="0" scrolling="no"></iframe> */}
      {/* {loading ? (
